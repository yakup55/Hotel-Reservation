            ...
            <TableBody>
              <Table>
                <TableRow style={{ backgroundColor: "black" }}>
                  ...
                  <TableCell style={{ color: "white" }}>Travel Name</TableCell>
                  <TableCell style={{ color: "white" }}>
                    Travel Message
                  </TableCell>
                  <TableCell style={{ color: "white" }}>Travel Image</TableCell>
                  <TableCell style={{ color: "white" }}>Travel Date</TableCell>
                  <TableCell style={{ color: "white" }}>
                    Travel Status
                  </TableCell>
                  <TableCell style={{ color: "white" }}>
                ...
                {currentPost?.map((travelWriting) => (
                  <TableRow>
                    ...
                    <TableCell>{travelWriting.travelStatus}</TableCell>
                    ...
                    <TableCell>
                      <Button
                        onClick={() =>
                          navigate(
                            `/adminupdateroom/${travelWriting.travelWritingId}`
                          )
                        }
