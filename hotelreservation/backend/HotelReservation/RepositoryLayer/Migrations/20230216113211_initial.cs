    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 2, 16, 14, 32, 11, 541, DateTimeKind.Local).AddTicks(4378), "10 larca oteli tercihlerinize göre filtreleyerek saniyeler içinde size en uygun otelleri bulabilirsiniz", "https://cdn.enuygun.com/otel/v-083f8/static/images/icons/option.svg", "Sayısız Seçenek" },
                    { 2, new DateTime(2023, 2, 16, 14, 32, 11, 541, DateTimeKind.Local).AddTicks(4394), "Kafanızı karıştıran fiyat ve hizmet seçenekleri arasında kaybolmayın, tercihlerinizi belirleyip size en uygun otelde odanızı hemen ayırtın.", "https://cdn.enuygun.com/otel/v-083f8/static/images/icons/location.svg", "Uygun Oteller" },
                    { 3, new DateTime(2023, 2, 16, 14, 32, 11, 541, DateTimeKind.Local).AddTicks(4395), "Enuygun sayesinde aradığınız oteli bulmak için sadece birkaç saniyeye ihtiyacınız var.", "https://cdn.enuygun.com/otel/v-083f8/static/images/icons/fast-easy.svg", "Hızlı Ve Kolay" },
                    { 4, new DateTime(2023, 2, 16, 14, 32, 11, 541, DateTimeKind.Local).AddTicks(4397), "Tüm ödeme işleriniz, dünyanın önde gelen güvenlik sertifikası şirketi DigiCert koruması altındadır.", "https://cdn.enuygun.com/otel/v-083f8/static/images/icons/trust.svg", "Güvenle Alın" }
                });
